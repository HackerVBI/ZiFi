...
START
	LD HL,0;TrackBuffer-96;MDLADDR
	JR INIT
	JP PLAY
	JR MUTE
@PlayerSettings:
SETUP	DB 0+0*4 ;set bit0 to 1, if you want to play without looping
...
;HL - AddressOfModule
	...
	LD (MDADDR2),HL
	PUSH HL
	LD DE,100		; SPKE: FOR SHORT HEADERS PT96
	ADD HL,DE
	LD A,(HL)
	LD (Delay),A
	PUSH HL
...
TP_2	LD A,H
	...
	LD A,(IX+98-100) ;EXTRACT VERSION NUMBER	; SPKE: FOR SHORT HEADERS PT96
	SUB #30
	JR C,L20
	CP 10
	JR C,L21
...
;ROUT_A0
		...
		and a
		ret m
;		jp p,DoReg13	; 4+12+7+4+10 = 37t

;		add hl,hl	; WASTED
;		jr DontReg13	; 11+12 = 23t

DoReg13:	ld b,e
		out (c),a
		;ld (hl),d	; 4+12+7 = 23t
				; OVERALL: 31+520+37+23 = 611t
DontReg13:	ret
		ENDIF
